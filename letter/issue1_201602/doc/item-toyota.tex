...
\newblock {Model-based Toolchain for the Efficient Development of
  Safety-Relevant Automotive Embedded Systems}.
...
\newblock {Seamless Model-Based Development: From Isolated Tools to Integrated
...
Y.~Ma, H.~Yu, T.~Gautier, P.~{Le Guernic}, J.-P. Talpin, L.~Besnard, and
  M.~Heitz.
\newblock {Toward Polychronous Analysis and Validation for Timed Software
...
\newblock {Aerospace Standard AS5506A: Architecture Analysis and Design
  Language (AADL) }.
...
M.~Shaw and D.~Garlan.
\newblock {\em {Software Architecture: Perspectives on an Emerging
  Discipline}}.
...
\newblock {Polychronous Modeling, Analysis, Verification and Simulation for
  Timed Software Architectures}.
...
\newblock {S}ystem-level {C}o-simulation of {I}ntegrated {A}vionics {U}sing
  {P}olychrony.
